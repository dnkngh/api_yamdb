# Generated by Django 2.2.16 on 2022-04-28 19:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(error_messages={'validator': 'Оценка должна быть в диапазоне от 0 до 10.'}, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='Оценка произведения.')),
